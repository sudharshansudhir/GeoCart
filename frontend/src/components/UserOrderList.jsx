...
const UserOrderList = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 md:px-6 py-14">
      ...
      <div className="space-y-8">
        {Object.entries(groupedOrders).map(([paymentId, orderItems]) => {
          // ✅ Sum all amounts for this paymentId
  ...
  return sum + product.price * order.quantity;
          ...
          return (
            ...
            >
              {/* ORDER HEADER */}
              <div className="flex flex-col md:flex-row justify-between items-start md:items-center px-5 py-4 border-b gap-2">
                <div>
                ...
                <span className="text-sm font-semibold text-green-600 bg-green-50 px-3 py-1 rounded-full w-fit">
                  Paid
                </span>
              </div>
              ...
              <div className="divide-y">
                {orderItems.map((order) => {
                  ...
                  return (
                    <div
                      key={order._id}
                      className="flex flex-col sm:flex-row gap-4 items-center px-5 py-4"
                    >
                      <img
                        src={product.img}
                        alt={product.name}
