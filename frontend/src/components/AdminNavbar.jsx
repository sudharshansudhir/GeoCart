...
//   }
  return (
    <div className='flex p-2 bg-green-300 justify-between top-0 fixed w-full z-20 items-center'>
        ...
        <NavLink to="/signin" onClick={()=>logouthandle()} className="px-3 py-1 border border-black rounded-md bg-green-700 hover:bg-[#c10404ff] hover-border-[#000000] text-xl">Logout</NavLink>
    </div>
  )
}
